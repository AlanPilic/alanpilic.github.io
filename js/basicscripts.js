...
function dynamicCreate() {
    ...
    document.getElementById("dynamic-row").innerHTML += "<div class='col-md-6 dynamic-block'>" +
        "<img width='auto' src='img/sliderImg" + picture + ".jpg' style='max-height: 306px; margin-top: 20px;'>" +
        "<h3> Picture " + "<span style='color: #af93ff;'>" + picture + " </span> in the header </h3>" +
...
document.getElementById("click-me-1").addEventListener("click", dynamicCreate1);
